...
<head>
    ...
    <title>LibraSync — @yield('title', 'Admin')</title>
    ...
    <style>
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
        ...
        .sidebar-role{margin:0 12px 8px;padding:4px 10px;background:rgba(255,165,0,0.15);border:1px solid rgba(255,165,0,0.3);border-radius:20px;font-size:10px;font-weight:700;color:#ffa500;letter-spacing:1.5px;text-transform:uppercase;text-align:center;}
        ...
        .avatar{width:34px;height:34px;background:var(--red-main);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;color:#fff;cursor:pointer;}
        ...
        .stat-card-top{display:flex;flex-direction:column;gap:2px;width:100%;}
        ...
        .btn-reject{background:rgba(107,0,0,0.08);color:var(--maroon-mid);border:1px solid var(--border);}
        .btn-reject:hover{background:rgba(192,57,43,0.1);color:var(--red-bright);}
        ...
        .modal{background:#fff;border-radius:16px;padding:28px;width:90%;max-width:620px;max-height:85vh;overflow-y:auto;position:relative;animation:mup .3s ease;}
        ...
        .modal-stat{background:var(--cream);border-radius:9px;padding:14px;min-height:90px;display:flex;flex-direction:column;justify-content:space-between;position:relative;overflow:hidden;}
        .modal-stat::before{content:'';position:absolute;top:0;left:0;width:4px;height:100%;background:linear-gradient(180deg,var(--red-bright),var(--maroon-mid));}
        .modal-stat-label{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:var(--text-muted);padding-left:8px;}
        .modal-stat-value{font-family:'Playfair Display',serif;font-size:36px;font-weight:700;color:var(--maroon-deep);line-height:1;text-align:right;}

        /* ACTIVITY FEED */
        .activity-item{display:flex;align-items:flex-start;gap:10px;padding:10px 0;border-bottom:1px solid rgba(232,213,196,0.4);}
        .activity-item:last-child{border-bottom:none;}
        .activity-dot{width:32px;height:32px;border-radius:50%;background:var(--cream);display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:700;color:var(--maroon-mid);flex-shrink:0;}
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.account-requests') }}" class="nav-item {{ request()->routeIs('admin.account-requests') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.database') }}" class="nav-item {{ request()->routeIs('admin.database') ? 'active' : '' }}">
            <svg class="nav-icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>
            Database
        </a>
